      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-blue-600 via-blue-700 to-slate-950">
        ...
        <div>
          ...
          <p className="text-blue-100 text-lg max-w-xl">
            Manage AI conversations, customer tickets, and support analytics
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-white/10 rounded-2xl p-4 backdrop-blur">
            ...
            <p className="text-sm text-blue-100">Automation</p>
          </div>

          <div className="bg-white/10 rounded-2xl p-4 backdrop-blur">
            <p className="text-2xl font-bold">JWT</p>
            <p className="text-sm text-blue-100">Secured</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-slate-900/80 border border-slate-800 rounded-3xl shadow-2xl p-8">
            <div className="mb-8">
              ...
              <p className="text-blue-400 font-semibold mb-2">Welcome back</p>
